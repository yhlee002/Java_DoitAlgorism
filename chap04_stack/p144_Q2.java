...
public class p144_Q2 {
    ...
    static class GStack<E> { //generic타입을 받는 stack
        private int max;
        private int ptr;
        private E[] stk;

        @SuppressWarnings("unchecked")
            // 모든 타입이 올 수 있기 때문에 타입 안정성이 낮다.
...
//		stk = new E[max];  ->generic array creation : Error(자바에선 제네릭 배열 생성이 허용되지 않음
        ...
        void push(E obj) throws OverflowIntStackException {
            stk[ptr++] = obj;
            if (ptr == max) {
        ...
        E pop() throws EmptyIntStackException {
            if (ptr == 0) {
        ...
        E peek() throws EmptyIntStackException {
            if (ptr == 0) {
                throw new EmptyIntStackException();
            }
            return stk[ptr - 1];
    ...
    public static void main(String[] args) {
        GStack<String> stStr = new GStack<String>(50);
        GStack<Integer> stInt = new GStack<Integer>(50);
        ...
        switch (whatStack) {
            case 0:
                ...
                if (strSearch != -1) {
                    System.out.println("stStr.indexOf() : " + strSearch);
                } else {
